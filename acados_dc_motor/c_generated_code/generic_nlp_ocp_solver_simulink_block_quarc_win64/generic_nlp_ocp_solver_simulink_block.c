  ...
  *generic_nlp_ocp_solver_simulink_block(void)
{
  ...
  /* External mode info */
  generic_nlp_ocp_solver_simulink_block_M->Sizes.checksums[0] = (3168941992U);
  generic_nlp_ocp_solver_simulink_block_M->Sizes.checksums[1] = (3037078583U);
  generic_nlp_ocp_solver_simulink_block_M->Sizes.checksums[2] = (2312911199U);
  generic_nlp_ocp_solver_simulink_block_M->Sizes.checksums[3] = (282615361U);
