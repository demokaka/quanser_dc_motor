...
typedef RT_MODEL_generic_nlp_ocp_solver_simulink_block_T RT_MODEL;

/*====================*
 * External functions *
 *====================*/
EXTERN RT_MODEL * generic_nlp_ocp_solver_simulink_block(void);
  ...
  _do_assertion(const char * expression, const char * file_name, int line_number)
{
  ...
  rtmSetErrorStatus(generic_nlp_ocp_solver_simulink_block_M, GBLbuf.message);
}
  ...
  main(int argc, char * argv[])
{
  ...
  rtExtModeQuarcParseArgs(argc, (const char **) argv,
    "shmem://generic_nlp_ocp_solver_simulink_block:1");
  ...
  if (parseError) {
    (void) fprintf(stderr,
                   "\nUsage: generic_nlp_ocp_solver_simulink_block -option1 val1 -option2 val2 -option3 ...\n\n");
    (void) fprintf(stderr,
   ...
   ************************/
  S = generic_nlp_ocp_solver_simulink_block();
  if (rtmGetErrorStatus(S) != NULL) {
