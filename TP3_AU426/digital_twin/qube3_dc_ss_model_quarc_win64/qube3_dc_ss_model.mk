###########################################################################
## Makefile generated for component 'qube3_dc_ss_model'. 
## 
## Makefile     : qube3_dc_ss_model.mk
## Generated on : Wed Nov 26 14:03:04 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\qube3_dc_ss_model.rt-win64
...
PRODUCT_NAME              = qube3_dc_ss_model
MAKEFILE                  = qube3_dc_ss_model.mk
...
COMPILER_COMMAND_FILE     = qube3_dc_ss_model_comp.rsp
CMD_FILE                  = qube3_dc_ss_model.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\qube3_dc_ss_model.rt-win64
...
DEFINES_STANDARD = -DMODEL=qube3_dc_ss_model -DNUMST=2 -DNCSTATES=2 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\qube3_dc_ss_model_quarc_win64\qube3_dc_ss_model.c $(START_DIR)\qube3_dc_ss_model_quarc_win64\qube3_dc_ss_model_data.c $(START_DIR)\qube3_dc_ss_model_quarc_win64\qube3_dc_ss_model_main.c $(START_DIR)\qube3_dc_ss_model_quarc_win64\rtGetInf.c $(START_DIR)\qube3_dc_ss_model_quarc_win64\rtGetNaN.c $(START_DIR)\qube3_dc_ss_model_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = qube3_dc_ss_model.obj qube3_dc_ss_model_data.obj qube3_dc_ss_model_main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\qube3_dc_ss_model_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\qube3_dc_ss_model_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
qube3_dc_ss_model.obj : "$(START_DIR)\qube3_dc_ss_model_quarc_win64\qube3_dc_ss_model.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\qube3_dc_ss_model_quarc_win64\qube3_dc_ss_model.c"


qube3_dc_ss_model_data.obj : "$(START_DIR)\qube3_dc_ss_model_quarc_win64\qube3_dc_ss_model_data.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\qube3_dc_ss_model_quarc_win64\qube3_dc_ss_model_data.c"


qube3_dc_ss_model_main.obj : "$(START_DIR)\qube3_dc_ss_model_quarc_win64\qube3_dc_ss_model_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\qube3_dc_ss_model_quarc_win64\qube3_dc_ss_model_main.c"


rtGetInf.obj : "$(START_DIR)\qube3_dc_ss_model_quarc_win64\rtGetInf.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\qube3_dc_ss_model_quarc_win64\rtGetInf.c"


rtGetNaN.obj : "$(START_DIR)\qube3_dc_ss_model_quarc_win64\rtGetNaN.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\qube3_dc_ss_model_quarc_win64\rtGetNaN.c"


rt_nonfinite.obj : "$(START_DIR)\qube3_dc_ss_model_quarc_win64\rt_nonfinite.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\qube3_dc_ss_model_quarc_win64\rt_nonfinite.c"
