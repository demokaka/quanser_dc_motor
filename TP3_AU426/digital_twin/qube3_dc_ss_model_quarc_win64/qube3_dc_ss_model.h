...
#ifndef RTW_HEADER_qube3_dc_ss_model_h_
#define RTW_HEADER_qube3_dc_ss_model_h_
#ifndef qube3_dc_ss_model_COMMON_INCLUDES_
#define qube3_dc_ss_model_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* qube3_dc_ss_model_COMMON_INCLUDES_ */

#include "qube3_dc_ss_model_types.h"
...
#define qube3_dc_ss_model_rtModel      RT_MODEL_qube3_dc_ss_model_T

/* Block signals (default storage) */
typedef struct {
  real_T Sum;                          /* '<Root>/Sum' */
  real_T omegarads;                    /* '<Root>/counts//s to rad//s' */
  real_T StateSpace1[2];               /* '<Root>/State-Space1' */
} B_qube3_dc_ss_model_T;

/* Block states (default storage) for system '<Root>' */
typedef struct {
  real_T HILInitialize_FilterFrequency[2];/* '<S1>/HIL Initialize' */
  real_T HILReadTimebase_AnalogBuffer; /* '<S1>/HIL Read Timebase' */
  real_T HILReadTimebase_OtherBuffer;  /* '<S1>/HIL Read Timebase' */
...
#define rtB                            qube3_dc_ss_model_B
#define BlockIO                        B_qube3_dc_ss_model_T
#define rtX                            qube3_dc_ss_model_X
#define ContinuousStates               X_qube3_dc_ss_model_T
#define rtXdot                         qube3_dc_ss_model_XDot
#define StateDerivatives               XDot_qube3_dc_ss_model_T
#define tXdis                          qube3_dc_ss_model_XDis
#define StateDisabled                  XDis_qube3_dc_ss_model_T
#define rtP                            qube3_dc_ss_model_P
#define Parameters                     P_qube3_dc_ss_model_T
#define rtDWork                        qube3_dc_ss_model_DW
#define D_Work                         DW_qube3_dc_ss_model_T

/* Parameters (default storage) */
struct P_qube3_dc_ss_model_T_ {
  real_T A1[4];                        /* Variable: A1
                                        * Referenced by: '<Root>/State-Space1'
                                        */
  real_T B1[2];                        /* Variable: B1
                                        * Referenced by: '<Root>/State-Space1'
                                        */
  real_T C1[4];                        /* Variable: C1
                                        * Referenced by: '<Root>/State-Space1'
                                        */
...
struct tag_RTM_qube3_dc_ss_model_T {
  const char_T *path;
...
extern P_qube3_dc_ss_model_T qube3_dc_ss_model_P;

/* Block signals (default storage) */
extern B_qube3_dc_ss_model_T qube3_dc_ss_model_B;

/* Continuous states (default storage) */
extern X_qube3_dc_ss_model_T qube3_dc_ss_model_X;

/* Block states (default storage) */
extern DW_qube3_dc_ss_model_T qube3_dc_ss_model_DW;

/* External data declarations for dependent source files */
extern const real_T qube3_dc_ss_model_RGND;/* real_T ground */

/* Model entry point functions */
extern void qube3_dc_ss_model_initialize(void);
extern void qube3_dc_ss_model_output(void);
extern void qube3_dc_ss_model_update(void);
extern void qube3_dc_ss_model_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern qube3_dc_ss_model_rtModel *qube3_dc_ss_model(void);
...
extern RT_MODEL_qube3_dc_ss_model_T *const qube3_dc_ss_model_M;
 ...
 *
 * '<Root>' : 'qube3_dc_ss_model'
 * '<S1>'   : 'qube3_dc_ss_model/Qube-Servo - IO (QAL)'
 */
#endif                                 /* RTW_HEADER_qube3_dc_ss_model_h_ */
