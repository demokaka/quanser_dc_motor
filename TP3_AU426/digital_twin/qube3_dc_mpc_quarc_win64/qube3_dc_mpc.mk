###########################################################################
## Makefile generated for component 'qube3_dc_mpc'. 
## 
## Makefile     : qube3_dc_mpc.mk
## Generated on : Wed Nov 26 14:23:45 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\qube3_dc_mpc.rt-win64
...
PRODUCT_NAME              = qube3_dc_mpc
MAKEFILE                  = qube3_dc_mpc.mk
MATLAB_ROOT               = C:\PROGRA~1\MATLAB\R2023a
MATLAB_BIN                = C:\PROGRA~1\MATLAB\R2023a\bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)\win64
START_DIR                 = C:\Users\dinhck\dev\project\quanser_dc_motor\TP3_AU426\digital_twin
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 1
TGT_FCN_LIB               = ISO_C
...
COMPILER_COMMAND_FILE     = qube3_dc_mpc_comp.rsp
CMD_FILE                  = qube3_dc_mpc.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\qube3_dc_mpc.rt-win64
...
DEFINES_STANDARD = -DMODEL=qube3_dc_mpc -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(MATLAB_ROOT)\rtw\c\src\rt_matrx.c $(MATLAB_ROOT)\rtw\c\src\rt_printf.c $(START_DIR)\qube3_dc_mpc_quarc_win64\qube3_dc_mpc.c $(START_DIR)\qube3_dc_mpc_quarc_win64\qube3_dc_mpc_data.c $(START_DIR)\qube3_dc_mpc_quarc_win64\qube3_dc_mpc_main.c $(START_DIR)\qube3_dc_mpc_quarc_win64\rtGetInf.c $(START_DIR)\qube3_dc_mpc_quarc_win64\rtGetNaN.c $(START_DIR)\qube3_dc_mpc_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c $(START_DIR)\mpc_solver_wrapper.c $(START_DIR)\mpc_solver.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = rt_matrx.obj rt_printf.obj qube3_dc_mpc.obj qube3_dc_mpc_data.obj qube3_dc_mpc_main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_sim.obj mpc_solver_wrapper.obj mpc_solver.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\qube3_dc_mpc_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\qube3_dc_mpc_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
qube3_dc_mpc.obj : "$(START_DIR)\qube3_dc_mpc_quarc_win64\qube3_dc_mpc.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\qube3_dc_mpc_quarc_win64\qube3_dc_mpc.c"


qube3_dc_mpc_data.obj : "$(START_DIR)\qube3_dc_mpc_quarc_win64\qube3_dc_mpc_data.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\qube3_dc_mpc_quarc_win64\qube3_dc_mpc_data.c"


qube3_dc_mpc_main.obj : "$(START_DIR)\qube3_dc_mpc_quarc_win64\qube3_dc_mpc_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\qube3_dc_mpc_quarc_win64\qube3_dc_mpc_main.c"


rtGetInf.obj : "$(START_DIR)\qube3_dc_mpc_quarc_win64\rtGetInf.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\qube3_dc_mpc_quarc_win64\rtGetInf.c"


rtGetNaN.obj : "$(START_DIR)\qube3_dc_mpc_quarc_win64\rtGetNaN.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\qube3_dc_mpc_quarc_win64\rtGetNaN.c"


rt_nonfinite.obj : "$(START_DIR)\qube3_dc_mpc_quarc_win64\rt_nonfinite.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\qube3_dc_mpc_quarc_win64\rt_nonfinite.c"
...
mpc_solver_wrapper.obj : "$(START_DIR)\mpc_solver_wrapper.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\mpc_solver_wrapper.c"


mpc_solver.obj : "$(START_DIR)\mpc_solver.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\mpc_solver.c"
