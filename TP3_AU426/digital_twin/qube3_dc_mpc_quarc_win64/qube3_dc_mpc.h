...
#ifndef RTW_HEADER_qube3_dc_mpc_h_
#define RTW_HEADER_qube3_dc_mpc_h_
#ifndef qube3_dc_mpc_COMMON_INCLUDES_
#define qube3_dc_mpc_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* qube3_dc_mpc_COMMON_INCLUDES_ */
...
#define qube3_dc_mpc_rtModel           RT_MODEL_qube3_dc_mpc_T
...
typedef struct {
  ...
  real_T omega_refrads;                /* '<Root>/Constant' */
  real_T TmpSignalConversionAtSFunctio_j[2];
...
typedef struct {
  ...
  real_T HILReadTimebase_AnalogBuffer; /* '<S2>/HIL Read Timebase' */
  real_T HILReadTimebase_OtherBuffer;  /* '<S2>/HIL Read Timebase' */
  t_card HILInitialize_Card;           /* '<S2>/HIL Initialize' */
  t_task HILReadTimebase_Task;         /* '<S2>/HIL Read Timebase' */
  real_T SFunction_RWORK[7515];        /* '<Root>/S-Function' */
  void *SFunction_PWORK[225];          /* '<Root>/S-Function' */
  ...
  struct {
    void *LoggedData;
  } omegarads_PWORK;                   /* '<Root>/omega (rad//s)' */

  struct {
    void *LoggedData;
  } statexthetaomega_PWORK;            /* '<Root>/state x=[theta, omega]'' */
  ...
  int32_T HILReadTimebase_EncoderBuffer[2];/* '<S2>/HIL Read Timebase' */
  int_T SFunction_IWORK[920];          /* '<Root>/S-Function' */
  t_boolean HILReadTimebase_DigitalBuffer;/* '<S2>/HIL Read Timebase' */
} DW_qube3_dc_mpc_T;

/* Backward compatible GRT Identifiers */
#define rtB                            qube3_dc_mpc_B
#define BlockIO                        B_qube3_dc_mpc_T
#define rtP                            qube3_dc_mpc_P
#define Parameters                     P_qube3_dc_mpc_T
#define rtDWork                        qube3_dc_mpc_DW
#define D_Work                         DW_qube3_dc_mpc_T

/* Parameters (default storage) */
struct P_qube3_dc_mpc_T_ {
  ...
  real_T countsstorads_Gain;           /* Expression: 2*pi/512/4
                                        ...
                                        */
  real_T thetarefdeg_Value;            /* Expression: 0
...
extern P_qube3_dc_mpc_T qube3_dc_mpc_P;

/* Block signals (default storage) */
extern B_qube3_dc_mpc_T qube3_dc_mpc_B;

/* Block states (default storage) */
extern DW_qube3_dc_mpc_T qube3_dc_mpc_DW;

/* Model entry point functions */
extern void qube3_dc_mpc_initialize(void);
extern void qube3_dc_mpc_output(void);
extern void qube3_dc_mpc_update(void);
extern void qube3_dc_mpc_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern qube3_dc_mpc_rtModel *qube3_dc_mpc(void);
...
extern RT_MODEL_qube3_dc_mpc_T *const qube3_dc_mpc_M;
 ...
 *
 * '<Root>' : 'qube3_dc_mpc'
 * '<S1>'   : 'qube3_dc_mpc/Degrees to Radians'
 * '<S2>'   : 'qube3_dc_mpc/Qube-Servo - IO (QAL)'
 */
#endif                                 /* RTW_HEADER_qube3_dc_mpc_h_ */
